...
public class ListViewComposite extends Composite {
    ...
    public ListViewComposite(Composite parent, int style) {
        super(parent, style);
    ...
    private void createDetailedInformationGroup() {
        Group detailedInformationGroup = new Group(this.getParent(), SWT.SHADOW_ETCHED_IN);
