...
public class SQLQueries {
     ...
     * table
     */
    public static final String MOVIES_QUERY = "SELECT VIDEO.VIDEO_ID, VIDEO.TITLE, VIDEO.RELEASE_DATE, VIDEO.RATING, VIDEO.PARENTAL_RATING, VIDEO.TTID, VIDEO.PATH, VIDEO.DETAIL_POSTER, VIDEO.SEARCH_TITLE, VIDEO.RUNTIME, VIDEO.SYSTEM, VIDEO.VIDEO_CODEC, VIDEO.RESOLUTION, VIDEO.FPS FROM VIDEO LEFT OUTER JOIN VIDEO_ATTR ON VIDEO.VIDEO_ID = VIDEO_ATTR.VIDEO_ID WHERE VIDEO_ATTR.VALUE='feature' ORDER BY VIDEO.TITLE";
