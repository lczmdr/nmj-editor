...
public class SQLQueries {
     ...
     * table
     */
    public static final String MOVIES_QUERY = "SELECT VIDEO.VIDEO_ID, VIDEO.TITLE, VIDEO.RELEASE_DATE, VIDEO.RATING, VIDEO.PATH, VIDEO.DETAIL_POSTER, VIDEO.RUNTIME, VIDEO.SYSTEM, VIDEO.VIDEO_CODEC, VIDEO.RESOLUTION, VIDEO.FPS FROM VIDEO LEFT OUTER JOIN VIDEO_ATTR ON VIDEO.VIDEO_ID = VIDEO_ATTR.VIDEO_ID WHERE VIDEO_ATTR.VALUE='feature' ORDER BY VIDEO.TITLE";
